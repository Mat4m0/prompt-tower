...
export function getCurrentPromptPresetVersion(preset: PromptPreset): PromptPresetVersion {
  const version = preset.versions.find((candidate) => candidate.id === preset.currentVersionId)
  if (!version) {
