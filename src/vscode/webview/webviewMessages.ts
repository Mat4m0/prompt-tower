...
export type WebviewToExtensionMessage =
  ...
  | { type: "context.create"; copy: boolean; treeMode: ProjectTreeMode; outputMode: ContextOutputMode }
  | { type: "context.copyPreview"; text: string }
  | { type: "context.save"; options: Partial<PromptExportOptions>; treeMode: ProjectTreeMode; outputMode: ContextOutputMode }
